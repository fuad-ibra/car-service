 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            } else functions_FLS(`[gotoBlock]: Такого блока нет на странице: ${targetBlock}`);
        };
        function formRating() {
            ...
            function pageNavigationAction(e) {
                if ("click" === e.type) {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        const gotoSpeed = gotoLink.dataset.gotoSpeed ? gotoLink.dataset.gotoSpeed : 1e3;
        ...
        da.init();
        const counters = document.querySelectorAll(".experience__num");
        const speed = 250;
        const countersParent = document.querySelector(".experience__items");
        window.addEventListener("scroll", (() => {
            let scrollTop = countersParent.getBoundingClientRect().top;
            let windowHeight = window.innerHeight;
            let point = 100;
            if (scrollTop < windowHeight - point) counters.forEach((counter => {
                const updateCount = () => {
